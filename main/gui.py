...
class MainWindow(QMainWindow):
    ...
    def setup_buttons(self):
        ...
        export_vid_btn = QPushButton("Export Result Video")
        export_vid_btn.setFixedHeight(25)
        export_vid_btn.setMinimumWidth(120)
        export_vid_btn.clicked.connect(self.controller.export_video)
        self.button_layout.addWidget(export_vid_btn)
